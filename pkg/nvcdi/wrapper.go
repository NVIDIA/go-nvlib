...
import (
	...
	"github.com/NVIDIA/go-nvlib/pkg/nvcdi/spec"
	"github.com/NVIDIA/go-nvlib/pkg/nvcdi/transform"
)

const envVarNvidiaVisibleDevices = "NVIDIA_VISIBLE_DEVICES"
...
func (m *wrapper) GetCommonEdits() (*cdi.ContainerEdits, error) {
	...
	edits.Env = append(edits.Env, envVarNvidiaVisibleDevices+"=void")
