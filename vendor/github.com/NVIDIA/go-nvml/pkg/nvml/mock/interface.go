...
//			},
//			GetExtendedInterfaceFunc: func() nvml.ExtendedInterface {
//				panic("mock out the GetExtendedInterface method")
//			},
...
type Interface struct {
	...
	// GetExtendedInterfaceFunc mocks the GetExtendedInterface method.
	GetExtendedInterfaceFunc func() nvml.ExtendedInterface
	...
	calls struct {
		...
		// GetExtendedInterface holds details about calls to the GetExtendedInterface method.
		GetExtendedInterface []struct {
		}
	...
	lockGetExtendedInterface                            sync.RWMutex
...
// GetExtendedInterface calls GetExtendedInterfaceFunc.
func (mock *Interface) GetExtendedInterface() nvml.ExtendedInterface {
	if mock.GetExtendedInterfaceFunc == nil {
		panic("Interface.GetExtendedInterfaceFunc: method is nil but Interface.GetExtendedInterface was just called")
	}
	callInfo := struct {
	}{}
	mock.lockGetExtendedInterface.Lock()
	mock.calls.GetExtendedInterface = append(mock.calls.GetExtendedInterface, callInfo)
	mock.lockGetExtendedInterface.Unlock()
	return mock.GetExtendedInterfaceFunc()
}

// GetExtendedInterfaceCalls gets all the calls that were made to GetExtendedInterface.
// Check the length with:
//
//	len(mockedInterface.GetExtendedInterfaceCalls())
func (mock *Interface) GetExtendedInterfaceCalls() []struct {
} {
	var calls []struct {
	}
	mock.lockGetExtendedInterface.RLock()
	calls = mock.calls.GetExtendedInterface
	mock.lockGetExtendedInterface.RUnlock()
	return calls
}
